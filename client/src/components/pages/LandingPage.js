...
function LandingPage(props) {
    return (
        <div id='landing' className='landing-page-container'>
            <div className='landing-splash-content'>
                ...
                <div className='landing-splash-button-container'>
                    <Link
                        className='landing-splash-button landing-signup-button' 
                        to='/signup'>Sign up</Link>
                    <Link 
                        className='landing-splash-button landing-login-button' 
